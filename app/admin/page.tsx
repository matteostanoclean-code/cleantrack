  ...
  return (
    <main className="min-h-screen bg-slate-950 p-6 text-white">
      <div className="mx-auto max-w-md space-y-4 rounded-3xl border border-slate-800 bg-slate-900 p-6">
        ...
        <Link href="/mitarbeiter/admin" className="block rounded-2xl bg-blue-600 px-5 py-3 text-center font-bold">Admin-Dashboard öffnen</Link>
        <Link href="/mitarbeiter/freigaben" className="block rounded-2xl border border-slate-700 bg-slate-950 px-5 py-3 text-center font-bold text-blue-100">Admin-Freigaben öffnen</Link>
